...
from .models import transaction, productTransaction,DailyProfit
...
from django.contrib import admin
from .models import DailyProfit
...
class DailyProfitAdmin(admin.ModelAdmin):
    list_display = ('date', 'user', 'total_sales_display', 'total_profit_display')
